...
registerDvars()
{
	...
	//###FIX### makeDvarServerInfo( "ui_hud_hardcore_show_compass", 0 );
	
	//###FIX### setDvar( "ui_hud_show_inventory", 0 );
	//###FIX### makeDvarServerInfo( "ui_hud_show_inventory", 0 );
...
endGame( winner, endReasonText )
{
	...
	randomTrack = randomInt(game["music"]["ct_intermission"].size);
	...
	for ( index = 0; index < players.size; index++ ) {
		...
		if ( !(level.teamBased && level.gametype != "bel") ) {
			if ( isDefined( winner ) && player == winner ) {
				...
				player.musicTimeWait = 13;
			}
			else if ( (!isDefined( player.pers["team"] ) || player.pers["team"] == "spectator") && !level.splitscreen ) {
				player playLocalSound( game["music"]["victory_spectator"] );
				player.musicTimeWait = 13.5;
			}/*
			else if ( (!isDefined( winner ) || winner == "tie") && !level.splitscreen) {
				player playLocalSound( game["music"]["victory_tie"] );
			}*/
			else {
				player playLocalSound( game["music"]["defeat"] );
				player.musicTimeWait = 21.5;
			}
		}
	}
	...
	if ( level.teamBased && level.gametype != "bel" ) {
		...
		if ( level.splitscreen ) {
			...
			if ( winner == "allies" ) {
				playSoundOnPlayers( game["music"]["victory_allies"], "allies" );
				changePlayersMusicDelay( "allies", 13);
				playSoundOnPlayers( game["music"]["defeat"], "axis" );
				changePlayersMusicDelay( "axis", 21.5);
			}
			else if ( winner == "axis" ) {
				playSoundOnPlayers( game["music"]["victory_axis"], "axis" );
				changePlayersMusicDelay( "axis", 13);
				playSoundOnPlayers( game["music"]["defeat"], "allies" );
				changePlayersMusicDelay( "allies", 21.5);
			}
			else if ( winner == "tie" ) {
				playSoundOnPlayers( game["music"]["victory_tie"] );
			}
			else {
				playSoundOnPlayers( game["music"]["defeat"] );
				changePlayersMusicDelayAll( 21.5 );
			}
		}
	}
	
	if( level.scr_musiconintermission )
		for ( index = 0; index < level.players.size; index++ )
		...
		if( isDefined(level.pers_killcam) ) {
			...
			for( i = 0; i < players.size; i++) {
				...
				players[i] thread maps\mp\gametypes\_killcam::killcam(
				    ...
				    level.pers_killcam["sWeapon"],
				    0.5,
				    level.pers_killcam["psOffsetTime"],
				    0,
				    undefined,
				    level.pers_killcam["perks"],
				    level.pers_killcam["attacker"]
				);
			}
			if( level.playingrwk ) {
				wait ( 3.0 );
...
menuAllies()
{
	...
	//self beginClassChoice();	//moved inside if
}
...
Callback_StartGameType()
{
	...
	if ( !isDefined( game["gamestarted"] ) ) {
		...
		game["music"]["defeat"] = "mp_defeat";	//"mp_defeat";
		game["music"]["victory_spectator"] = "ct_vic_spec";	//"mp_defeat";
		game["music"]["winning"] = "mp_time_running_out_winning";
		game["music"]["losing"] = "mp_time_running_out_losing";
		game["music"]["victory_tie"] = "ct_tie_bog_a";	//"mp_defeat";
		
		game["music"]["ct_intermission"] = [];
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_1";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_2";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_3";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_4";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_5";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_6";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_7";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_8";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_9";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_10";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_11";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_12";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_13";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_14";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_15";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_16";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_17";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_18";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_19";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_20";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_21";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_22";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_23";
		game["music"]["ct_intermission"][game["music"]["ct_intermission"].size] = "ct_intermission_24";
...
Callback_PlayerDisconnect()
{
	...
	for ( entry = 0; entry < level.players.size; entry++ ) {
		if ( isDefined( level.players[entry].killedPlayers[""+self.clientid] ) )
			level.players[entry].killedPlayers[""+self.clientid].count = 0; //fix: undefined before
			
		if ( isDefined( level.players[entry].killedPlayersCurrent[""+self.clientid] ) )
			level.players[entry].killedPlayersCurrent[""+self.clientid].count = 0; //fix: undefined before
			
		if ( isDefined( level.players[entry].killedBy[""+self.clientid] ) )
			level.players[entry].killedBy[""+self.clientid].count = 0; //fix: undefined before
	}
...
Callback_PlayerKilled(eInflictor, attacker, iDamage, sMeansOfDeath, sWeapon, vDir, sHitLoc, psOffsetTime, deathAnimDuration)
{
		...
		if ( attacker == self ) { // killed himself
			...
			if ( level.teamBased && self.pers["team"] == attacker.pers["team"] && sMeansOfDeath == "MOD_GRENADE" && level.friendlyfire == 0 ) {
					...
					if ( !isDefined( eInflictor ) || !isDefined( eInflictor.requiredDeathCount ) || attacker.deathCount == eInflictor.requiredDeathCount ) {
						...
						switch ( sWeapon ) {
							case "artillery_mp":
								...
								if( !level.scr_airstrike_add_kills ) {
									attacker incPersStat( "kills", -1 );
									attacker.kills = attacker getPersStat( "kills" );
									attacker updatePersRatio( "kdratio", "kills", "deaths" );
								}
							...
							case "hind_FFAR_mp":
								...
								if( !level.scr_helicopter_add_kills ) {
									attacker incPersStat( "kills", -1 );
									attacker.kills = attacker getPersStat( "kills" );
									attacker updatePersRatio( "kdratio", "kills", "deaths" );
								}
								break;
							case "claymore_mp":
								if( isDefined(attacker.claymoreAddKill) && !attacker.claymoreAddKill ) {
									attacker incPersStat( "kills", -1 );
									attacker.kills = attacker getPersStat( "kills" );
									attacker updatePersRatio( "kdratio", "kills", "deaths" );
									break;
				...
				if ( !isDefined( attacker.killedPlayers[name] ) ) {
					attacker.killedPlayers[name] = spawnstruct();
					attacker.killedPlayers[name].count = 0;
				}
				
				if ( !isDefined( attacker.killedPlayersCurrent[name] ) ) {
					attacker.killedPlayersCurrent[name] = spawnstruct();
					attacker.killedPlayersCurrent[name].count = 0;
				}
				
				attacker.killedPlayers[name].count++;
				attacker.killedPlayers[name].person = self;
				attacker.killedPlayersCurrent[name].count++;
				attacker.killedPlayersCurrent[name].person = self;
				
				attackerName = ""+attacker.clientid;
				if ( !isDefined( self.killedBy[attackerName] ) ) {
					self.killedBy[attackerName] = spawnstruct();
					self.killedBy[attackerName].count = 0;
				}
				
				self.killedBy[attackerName].count++;
				self.killedBy[attackerName].person = attacker;
	...
	if( !isDefined(level.pers_killcam) )
		level.pers_killcam = [];
	level.pers_killcam["lpattacknum"] = lpattacknum;
	level.pers_killcam["killcamentity"] = killcamentity;
	level.pers_killcam["sWeapon"] = sWeapon;
...
delayStartRagdoll( ent, sHitLoc, vDir, sWeapon, eInflictor, sMeansOfDeath )
{
	...
	ragdollInstantly = false;
	
	if ( sMeansOfDeath == "MOD_EXPLOSIVE" || isSubStr(sMeansOfDeath, "MOD_GRENADE") || isSubStr(sMeansOfDeath, "MOD_PROJECTILE") ||
	     isSubStr(sWeapon, "m1014_") || isSubStr(sWeapon, "winchester1200_") ||
	     sHitLoc == "head" || sHitLoc == "helmet" || sMeansOfDeath == "MOD_MELEE" || sMeansOfDeath == "MOD_FALLING" )
		ragdollInstantly = true;
	...
	explosionRadius = 60;
	explosionForce = 0.65;
	if( isSubStr(sWeapon, "m1014_") || isSubStr(sWeapon, "winchester1200_") )
		explosionForce = 0.4;
	...
	if ( isDefined( ent ) ) {
		...
		if ( sMeansOfDeath == "MOD_EXPLOSIVE" || isSubStr(sMeansOfDeath, "MOD_GRENADE") || isSubStr(sMeansOfDeath, "MOD_PROJECTILE") || isSubStr(sWeapon, "m1014_") || isSubStr(sWeapon, "winchester1200_") ) {
			wait .05;
			physicsExplosionSphere( explosionPos, explosionRadius, explosionRadius/2, explosionForce );
		}
	}
...
getMostKilledBy()
{
	...
	for ( index = 0; index < killedByNames.size; index++ ) {
		...
		if ( self.killedBy[killedByName].count <= killCount )
			continue;
...
getMostKilled()
{
	...
	for ( index = 0; index < killedNames.size; index++ ) {
		...
		if ( self.killedPlayers[killedName].count <= killCount )
			continue;
			
		killCount = self.killedPlayers[killedName].count;
...
getMostKilledBySpecial()
{
	...
	for ( index = 0; index < killedByNames.size; index++ ) {
		killedByName = killedByNames[index];
		if( isDefined(self.killedBy[killedByName]) && isDefined(self.killedBy[killedByName].count) )
			if( self.killedBy[killedByName].count <= killCount )
				continue;
	...
	if( isDefined(self.killedBy[mostKilledBy]) && isDefined(self.killedBy[mostKilledBy].person) ) {
		self.ct_mostKilledBy = self.killedBy[mostKilledBy].person;
		self.ct_mostKilledByKC = killCount;
	}
	else {
		self.ct_mostKilledBy = undefined;
		self.ct_mostKilledByKC = 0;
	}
}


getMostKilledSpecial()
{
	mostKilled = "";
	killCount = 0;
	...
	for ( index = 0; index < killedNames.size; index++ ) {
		killedName = killedNames[index];
		if ( isDefined(self.killedPlayers[killedName]) && isDefined(self.killedPlayers[killedName].count) )
			if( self.killedPlayers[killedName].count <= killCount )
				continue;
	...
	if( isDefined(self.killedPlayers[mostKilled]) && isDefined(self.killedPlayers[mostKilled].person) ) {
		self.ct_mostKilled = self.killedPlayers[mostKilled].person;
		self.ct_mostKilledKC = killCount;
	}
	else {
		self.ct_mostKilled = undefined;
		self.ct_mostKilledKC = 0;
	}
}
...
updateGlobalStats( player )
{
	if( !isDefined(player.glbStat) )
		player.glbStat = spawnstruct();
		
	player.glbStat.rank = player getStat( 2301 );
	player.glbStat.score = player getStat( 2302 );
	player.glbStat.kills = player getStat( 2303 );
	player.glbStat.heads = player getStat( 2308 );
	player.glbStat.assists = player getStat( 2307 );
	player.glbStat.ks = player getStat( 2304 );
	player.glbStat.deaths = player getStat( 2305 );
	player.glbStat.suicides = self getStat( 2310 );
	player.glbStat.ds = player getStat( 2306 );
	player.glbStat.timeAll = player getStat( 2311 );
	player.glbStat.timeOpf = player getStat( 2312 );
	player.glbStat.timeOth = player getStat( 2313 );
	player.glbStat.tft = player getStat( 252 );
	player.glbStat.ttts = player getStat( 2326 );
	player.glbStat.wins = player getStat( 2316 );
	player.glbStat.losses = player getStat( 2317 );
	player.glbStat.ties = player getStat( 2318 );
	player.glbStat.hits = player getStat( 2322 );
	player.glbStat.misses = player getStat( 2323 );
	player.glbStat.totalShots = player getStat( 2324 );
}